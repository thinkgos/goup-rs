...
pub const GOVM_GO_HOST: &str = "GOVM_GO_HOST";
pub const GOVM_GO_DOWNLOAD_BASE_URL: &str = "GOVM_GO_DOWNLOAD_BASE_URL";
pub const GOVM_GO_SOURCE_GIT_URL: &str = "GOVM_GO_SOURCE_GIT_URL";
